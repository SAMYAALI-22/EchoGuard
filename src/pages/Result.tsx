    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-200/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 mb-1">Detected Emotion</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 mb-1">Analyzed</h3>
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-8">
          <h3 className="font-semibold text-gray-900 mb-3">What You Shared</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {recommendations.map((recommendation, index) => (
              <div key={index} className="flex items-start space-x-3 p-4 bg-gradient-to-r from-blue-50 to-emerald-50 rounded-lg border border-blue-100">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8 pt-8 border-t border-gray-200">
          ...
          <Link
            to="/"
            className="flex-1 bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 px-6 rounded-xl border border-gray-300 hover:border-gray-400 transition-all duration-200 text-center"
          >
            New Check-in
          </Link>
        </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div>
            <h4 className="font-medium text-blue-800 mb-2">Professional Help</h4>
          ...
          <div>
            <h4 className="font-medium text-blue-800 mb-2">Self-Care</h4>
            <ul className="space-y-1 text-blue-700">
